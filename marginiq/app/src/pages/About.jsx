  ...
  return (
    <div className="px-4 py-16 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-3xl">
        <h1 className="text-3xl font-extrabold text-armit-text sm:text-4xl">About MarginIQ</h1>
        <p className="mt-4 text-armit-muted">
          Refinery Margin Intelligence for African Refineries
        </p>
        ...
        <section className="mt-12 space-y-4 text-armit-muted">
          ...
          <p>
            MarginIQ was built to close that gap. It takes a real crude oil assay (Bonny Light,
        ...
        <section className="mt-12 space-y-4 text-armit-muted">
          <h2 className="flex items-center gap-2 text-xl font-semibold text-armit-text">
            ...
            MarginIQ Calculation Methodology
          </h2>
          <ul className="space-y-3">
            ...
            <li className="rounded-xl border border-white/5 bg-armit-card p-4">
              ...
              proprietary benchmarking data; MarginIQ provides an engineering proxy on the same
              underlying logic.
            </li>
            <li className="rounded-xl border border-white/5 bg-armit-card p-4">
        ...
        <section className="mt-12 space-y-4 text-armit-muted">
          ...
          <p className="rounded-xl border border-armit-amber/20 bg-armit-amber/5 p-4">
            MarginIQ is an educational and planning tool based on published engineering correlations
        ...
        <section className="mt-12 space-y-4 text-armit-muted">
          ...
          <p>
            ...
            configurations that those tools were never calibrated for. MarginIQ is built to make that
