...
import { computeArmitResult, computeConstraintAnalysis } from '../utils/calcEngine.js'
  ...
  return (
    <div className="px-4 py-10 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-12 flex flex-col items-center gap-4 rounded-2xl border border-white/10 bg-armit-card p-8 text-center sm:flex-row sm:justify-center">
          <PageCta to="/crude-advisor" variant="secondary">
            Compare Two Crudes
          </PageCta>
          <PageCta to="/constraint-simulator">Simulate Constraint Relief</PageCta>
        </div>
      </div>
    </div>
  )
