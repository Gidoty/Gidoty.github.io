...
tracks regulatory response and methane emissions in real time.

27 integrated features across 7 categories:
...
Charter Art. 24 · Paris Agreement Art. 6.4 · IPCC 2006 Tier 1

## Scientific Methodology

- Methane estimation: IPCC 2006 Tier 1
- Nigerian associated gas: 90% CH₄ (NNPC/DPR published data)
- Flare efficiency: 98% (API Compendium 2009)
- GWP: IPCC AR6 WGI 2021 (GWP₂₀=84, GWP₁₀₀=29.8)
- Evidence integrity: SHA-256 (Nigerian Evidence Act 2011 ss.84-87)

## Tech Stack

React 18 · Vite · Tailwind CSS · React Router v6 · Leaflet.js · leaflet.heat · Recharts · Web
Crypto API · Service Worker PWA

## Disclaimer

Community monitoring tool. Data constitutes community observations and does not replace formal
regulatory investigation. All reports labelled as community-submitted. Platform does not transmit
data to regulators directly.
