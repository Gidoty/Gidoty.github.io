...
const STEPS = [
  ...
  },
  {
    ...
    text: 'ARMIT computes true yields, gross margin, EII energy index, and identifies your binding constraints using LP shadow price logic.',
  },
  {
    icon: CheckCircle2,
    ...
    <div>
      ...
      <section className="bg-armit-panel px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-3xl font-bold text-armit-text sm:text-4xl">
              Why ARMIT over a crack spread calculator?
            </h2>
          </div>
