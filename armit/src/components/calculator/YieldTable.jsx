...
import { formatNum0, formatNum1, formatUsd0 } from '../../lib/format.js'
          ...
          <tbody>
            {products.map((p) => (
              <tr key={p.label} className="border-b border-white/5 last:border-0">
                ...
                <td className="py-2.5 pr-4 text-armit-muted">{formatNum1(p.pctOfCrude)}%</td>
          ...
          <tfoot>
            <tr className="border-t border-white/10 font-semibold">
              ...
              <td className="py-2.5 pr-4 text-armit-teal">
                {formatNum1((totalBpd / throughputBpd) * 100)}%
              </td>
